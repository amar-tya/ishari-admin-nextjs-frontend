...
export const SearchHistoryIcon: React.FC<IconProps> = ({
  className = '',
  size = 20,
}) => (
  <svg
...
// Translations icon
export const TranslationsIcon: React.FC<IconProps> = ({
  className = '',
  size = 20,
}) => (
  <svg
...
export const VersesIcon: React.FC<IconProps> = ({
  ...
  >
    <path
      d="M10 11C10 12.6569 8.65685 14 7 14C5.34315 14 4 12.6569 4 11C4 9.34315 5.34315 8 7 8C7.55228 8 8 7.55228 8 7C8 5.89543 8.89543 5 10 5V7C10 8.65685 8.65685 10 7 10"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
    />
    <path
      d="M20 11C20 12.6569 18.6569 14 17 14C15.3431 14 14 12.6569 14 11C14 9.34315 15.3431 8 17 8C17.5523 8 18 7.55228 18 7C18 5.89543 18.8954 5 20 5V7C20 8.65685 18.6569 10 17 10"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
    />
...
export const VerseMediaIcon: React.FC<IconProps> = ({
  className = '',
  size = 20,
}) => (
  <svg
...
export const BookPlusIcon: React.FC<IconProps> = ({
  className = '',
  size = 20,
}) => (
  <svg
  ...
  >
    <path
      d="M4 19.5C4 18.837 4.26339 18.2011 4.73223 17.7322C5.20107 17.2634 5.83696 17 6.5 17H18"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M6.5 2H18V22H6.5C5.83696 22 5.20107 21.7366 4.73223 21.2678C4.26339 20.7989 4 20.163 4 19.5V4.5C4 3.83696 4.26339 3.20107 4.73223 2.73223C5.20107 2.26339 5.83696 2 6.5 2Z"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const MasterDataIcon: React.FC<IconProps> = ({
  className = '',
  size = 32,
}) => (
  <svg
